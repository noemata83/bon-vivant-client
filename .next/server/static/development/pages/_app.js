...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dev__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dev */ "./config/dev.js");


let config;

if (false) {} else {
  config = _dev__WEBPACK_IMPORTED_MODULE_0__["default"];
}
...
function create(initialState, {
  ...
  const authLink = Object(apollo_link_context__WEBPACK_IMPORTED_MODULE_3__["setContext"])((_, previousContext) => {
...
function initApollo(initialState, options) {
  if (true) {
    let fetchOptions = {};
    return create(initialState, Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, options, {
      fetchOptions
    }));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (App => {
  ...
  return _temp = _class = class WithData extends react__WEBPACK_IMPORTED_MODULE_3__["Component"] {
    static async getInitialProps(ctx) {
      ...
      if (true) {
        ...
        try {
          await Object(react_apollo__WEBPACK_IMPORTED_MODULE_5__["getDataFromTree"])(react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(AppTree, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_1__["default"])({}, appProps, {
            apolloClient: apollo,
            __source: {
        ...
        next_head__WEBPACK_IMPORTED_MODULE_6___default.a.rewind(); // This is used to clear a side effect, since getDataFromTree does not call componentWillUnmount()
      }
    ...
    constructor(props) {
      super(props);
      this.apolloClient = Object(_initApollo__WEBPACK_IMPORTED_MODULE_7__["default"])(props.apolloState, {
        getToken: () => {
    ...
    render() {
      return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(App, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_1__["default"])({
  ...
  }, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(_class, "displayName", `WithData(${App.displayName})`), _temp;
});
...
class BonVivantApp extends next_app__WEBPACK_IMPORTED_MODULE_1___default.a {
  render() {
    const {
      Component,
      pageProps,
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_lib_withApollo__WEBPACK_IMPORTED_MODULE_4__["default"])(BonVivantApp));
