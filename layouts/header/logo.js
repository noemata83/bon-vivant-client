...
export default ({ className, style }) => (
  <Logo xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" enableBackground="new 0 0 100 100" version="1.1" viewBox="0 25 100 75" xmlSpace="preserve" className={className} style={style}>
  <g>
    <g>
      <g>
